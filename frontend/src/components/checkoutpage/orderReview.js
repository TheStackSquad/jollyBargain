...
const OrderReview = ({
  ...
  const shippingCost = useSelector((state) => {
    return state.cart.shippingCost || 0;
  });
      ...
      <div className="p-6 sm:p-8">
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-2xl border border-green-100 shadow-sm">
            ...
            <div className="space-y-1 text-gray-700">
              ...
              <p className="text-sm font-mono">
                **** **** **** {currentPaymentInfo.cardNumber ? currentPaymentInfo.cardNumber.slice(-4) : '0000'}
              </p>
              <p className="text-sm">
          ...
          <div className="bg-gray-50 rounded-2xl p-4 space-y-3">
            {cartItems && cartItems.length > 0 ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">No items in cart. Please add items to proceed.</p>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="border-t border-gray-300 pt-3 mt-3">
              <div className="flex justify-between items-center text-xl font-bold text-indigo-700">
                ...
                <span className="text-2xl">₦{calculatedGrandTotal.toFixed(2)}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:justify-between">
          <MotionButton
            ...
            whileTap="tap"
            onClick={onPrevStep}
            className="w-full sm:w-auto px-8 py-4 bg-gray-100 text-gray-700 font-medium rounded-2xl shadow-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 transition duration-200 ease-in-out border border-gray-200"
          >
          ...
          <MotionButton
            ...
            className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold rounded-2xl shadow-lg hover:from-green-700 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition duration-200 ease-in-out transform hover:scale-105"
          >
            Place Order
