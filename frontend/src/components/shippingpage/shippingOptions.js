  ...
  const shippingOptions = [
    {
      ...
      cost: 'From ₦1,500',
      description: 'Our most popular shipping option. Reliable and cost-effective for everyday orders.',
      features: ['Order tracking included', 'Delivery Monday-Saturday', 'Insurance up to ₦50,000'],
      color: 'bg-blue-500'
    },
    {
      icon: Zap,
      ...
      cost: 'From ₦3,500',
      description: 'Fast delivery for urgent orders. Perfect when you need items quickly.',
      features: ['Priority processing', 'Same-day dispatch', 'SMS & email updates'],
      color: 'bg-orange-500'
    },
    {
      icon: Gift,
      ...
      cost: 'Free on ₦25,000+',
      description: 'Enjoy free shipping on qualifying orders. No rush, great savings.',
      features: ['No minimum weight', 'Same tracking features', 'Perfect for bulk orders'],
      color: 'bg-green-500'
    },
    {
      icon: Globe,
      ...
      description: 'Worldwide delivery to over 150 countries. Bringing JollyBargain global.',
      features: ['Customs handling included', 'International tracking', 'Duty calculator available'],
      color: 'bg-purple-500'
    }
  ];
    ...
    <section className="py-16 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          >
            Select the shipping option that best fits your timeline and budget. All options include full tracking and insurance.
          </AnimatedP>
        </div>
