    ...
    <section className="py-16 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          >
            Important information about our shipping procedures, protection policies, and delivery standards.
          </AnimatedP>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600 font-roboto">
                ...
                <li>• Delivery to business addresses requires contact person</li>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
              ...
              <div className="mt-4 md:mt-0 flex space-x-4">
                <a
                  href="/contact"
                  className="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200 font-roboto font-medium"
                >
                  Contact Support
                </a>
                <a
                  href="/faq"
                  className="px-6 py-3 bg-white text-green-600 border-2 border-green-600 rounded-lg hover:bg-green-600 hover:text-white transition-all duration-200 font-roboto font-medium"
                >
                  View FAQ
                </a>
              </div>
