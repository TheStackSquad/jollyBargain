...
const ShippingHero = () => {
  return (
    <section className="bg-gradient-to-br from-green-600 via-emerald-700 to-teal-800 text-white py-20">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        >
          Fast, reliable, and affordable shipping options to get your orders delivered safely.
        </AnimatedP>
      </div>
    </section>
  );
