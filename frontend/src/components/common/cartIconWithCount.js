...
const CartIconWithCount = () => {
  ...
  return (
    <Link
      ...
      className="relative flex items-center text-white hover:text-blue-200 font-roboto transition-colors duration-300 hover:scale-105 transform"
    ...
    >
      ...
      {totalQuantity > 0 && (
        <span
          className="absolute -top-2 -right-2 md:right-0 bg-red-500 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center transform translate-x-1/2 -translate-y-1/2 md:translate-x-0 md:-translate-y-1/2"
