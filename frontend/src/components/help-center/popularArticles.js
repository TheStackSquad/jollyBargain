    ...
    <div className="mb-12">
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm">
        <div className="space-y-3">
          {popularArticles.map((article) => ( // Removed index from map if not used
            <AnimatedP
              ...
              transition={{ duration: 0.6, delay: popularArticles.indexOf(article) * 0.1 }} // Use indexOf for delay if index is not passed
            >
              <div>
                <a
                  href={article.url}
