  ...
  return (
    <AnimatedSection className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <AnimatedDiv className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md flex flex-col items-center">
        ...
        {successMessage && (
          <div
            className="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-4 w-full rounded-md"
            role="alert"
          >
        ...
        {error && (
          <div
            className="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-4 w-full rounded-md"
            role="alert"
          >
        ...
        <div className="relative flex py-5 items-center w-full mb-6">
          ...
          <AnimatedP className="flex-shrink mx-4 text-gray-400 text-sm">
            OR
          </AnimatedP>
          <div className="flex-grow border-t border-gray-300" />
        </div>
