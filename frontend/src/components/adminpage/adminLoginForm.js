...
function AdminLoginForm({ onAuthenticate, error: propError }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            <div className="relative">
              ...
              />
              <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-purple-500/20 to-blue-500/20 opacity-0 hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
            </div>
        ...
        {/* Warning section */}
        <div
          className={`mt-8 p-4 bg-yellow-500/20 border border-yellow-500/50 rounded-lg transform transition-all duration-700 delay-900 ${
            isMounted ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"
          }`}
        >
          <p className="text-yellow-300 text-xs flex items-center">
            ...
            Note: Admin accounts are provisioned by a Super Admin. No public
            registration.
          </p>
        </div>
      </div>
