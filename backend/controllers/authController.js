...
/**
 * @desc    Logs in a user (can be general user or admin)
 * @route   POST /api/auth/login
 * @access  Public
 * @param   {string} req.body.identifier - User's email or username.
 * @param   {string} req.body.password - User's password.
 * @returns {object} JSON response with success status, message, access token, and user data.
 * @throws  {400} Bad Request for missing credentials.
 * @throws  {401} Unauthorized for invalid credentials or inactive account.
 * @throws  {423} Locked for temporarily locked accounts.
 ...
 * @access  Private (or Public, just clears cookie)
...
/**
 * @desc    Refreshes the access token using a refresh token from cookie
 * @route   POST /api/auth/refresh-token
 * @access  Public (uses refresh token from cookie)
 * @returns {object} JSON response with success status and new access token.
 * @throws  {401} Unauthorized for invalid or missing refresh token.
 * @throws  {500} Internal Server Error for unexpected issues.
 */
 ...
 * @returns {object} JSON response with success status and user profile data.
